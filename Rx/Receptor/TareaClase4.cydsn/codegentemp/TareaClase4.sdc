...
# Date: Mon, 18 Mar 2019 02:21:40 GMT
#set_units -time ns
...
create_clock -name {WaveDAC8_DacClk(routed)} -period 2000000 -waveform {0 1000000} [list [get_pins {ClockBlock/dclk_3}]]
...
create_generated_clock -name {WaveDAC8_DacClk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 48001 96001} [list [get_pins {ClockBlock/dclk_glb_3}]]
